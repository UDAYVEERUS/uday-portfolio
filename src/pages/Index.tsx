...
const Index = () => {
  ...
  const projects = [
    {
      title: "Astro Tellers",
      description: `Astrotellers is an astrology and spiritual consultation platform developed using the MERN stack. The website allows users to explore various astrology services, book personalized consultations, and purchase spiritual products. I developed both the frontend and backend, ensuring a seamless user experience, real-time data handling, and secure payment processing. The platform features a dynamic service catalog, astrologer profiles, puja booking modules, and custom admin dashboards for managing content and orders. The project reflects a clean, scalable architecture with focus on performance, responsiveness, and ease of use.`,
      tech: ["React.js", "Node.js", "Express", "MongoDB", "Tailwind", "ShadCn", "React-Router", "Redux", "Redux-Thunk"],
    ...
    },
    {
      ...
      description: "Polarbearmeds is a mobile‑first online pharmacy built on the MERN stack with Next.js. It integrates the Pharmacy Wire API, seeding medicine data into a local database for fast searches and ingredient‑based recommendations. Users can refill or reorder prescriptions, receive email reminders, and recover abandoned carts, while a refer‑a‑friend loop drives growth. Sanity CMS powers dynamic content and ShadCN UI supplies accessible, reusable components. Secure credit‑card payments, performance tuning, and team collaboration ensure a smooth, reliable experience across devices, scaling efficiently with modern DevOps practices and rigorous automated testing.",
      tech: ["Next.js", "Sanity CMS", "React", , "Pharmacy wire", "MySql,", "JWT", "Node.js", "Tailwind.css", "Shadcn", "Bcrypt"],
  ...
  const shopifyprojects = [
    {
      title: "Copper Canoe Woman",
      description: `Built a custom Shopify store for Copper Canoe Woman, an Indigenous jewelry brand. Showcasing artisan collections—from Sterling and 14k to acrylic runway pieces—the site features seamless product browsing, responsive design, multi-currency support, Shopify Payments, and Shopify Apps, promoting ancestral storytelling and sustainable commerce.`,
      tech: ["Shopify", "Liquid", "HTML", "CSS", "JavaScript", "Shopify Apps"],
      demo: "https://www.coppercanoewoman.com",
      github: "#",
      featured: true,
    ...
    {
      title: "Arts Shala",
      description: `Designed and launched the Shopify store for Arts Shala, a Delhi-based art & craft studio. Featuring curated DIY kits, art supplies, and online workshop bookings, the site includes intuitive navigation, engaging product displays, responsive layouts, and secure checkout, elevating creative shopping experiences.`,
      tech: ["Shopify", "Liquid", "HTML", "CSS", "JavaScript", "Shopify Apps"],
      demo: "https://www.artsshala.com",
      github: "#",
      featured: true,
      color: "from-purple-500 to-indigo-500",
  ...
  const experience = [
    {
      ...
      description: `During my time at the company, I have led the development of marketing platforms and dashboards using the MERN stack, with a strong focus on performance optimization and advanced SEO integration. I actively collaborated with design and product teams to build custom CMS-driven websites that deliver exceptional performance and cross-platform compatibility. I played a key role in translating business goals into functional, scalable web solutions while maintaining high code quality through code reviews and mentoring junior developers. My contributions were recognized with the "Engineering Excellence" Award for the successful delivery of a high-profile project.`
    },
    {
      title: "Full Stack Developer",
      company: "PXYMedia OPC PVT LTD",
      period: "Sep 2023 – Dec 2023",
      description: `During my time at the company, I spearheaded the development of dynamic business websites by applying modern UI/UX principles and integrating third-party APIs to enhance functionality. I streamlined project workflows through the use of reusable modules and scalable architecture, significantly accelerating development cycles. I led QA testing efforts and established continuous feedback loops to ensure cross-browser compatibility and high-quality, stable releases. My work on performance optimization—using techniques like lazy loading, code-splitting, and advanced caching—greatly improved page load speeds and user experience. I collaborated closely with cross-functional teams, including designers, marketers, and product managers, to align technical solutions with strategic business goals.`
    },
    {
      title: "Full Stack Developer",
      company: "Shophree Retails PVT LTD",
      period: "March 2022 – APR 2023",
      description: `From March 2022 to APR 2023, I developed a feature-rich e-commerce platform using the MERN stack, incorporating secure user authentication, order management, and payment processing. I optimized backend performance and applied lazy-loading techniques, successfully reducing load times by 30%. I handled third-party API integrations and managed Git-based deployment workflows to ensure smooth development and release cycles. The platform was built with a responsive, mobile-first design approach, delivering a consistent user experience across all devices. Additionally, I integrated real-time notifications and order tracking features to boost customer engagement and satisfaction.
...
`
  ...
  const services = [
    ...
    "Admin Panels & Role-Based Dashboards with React & Node.js",
    "Real-Time Applications using Socket.io & MongoDB Change Streams",
    ...
    "Shopify Store Solutions",
    "Digital Marketing Solutions (SEO, Email, Social Media)",
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 text-gray-900">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 animate-fade-in">
              ...
              <div className="flex space-x-4 pt-4">
                {[
                  { icon: Github, href: "https://github.com/udayveerus", color: "hover:text-gray-900" },
                  { icon: Linkedin, href: "https://www.linkedin.com/in/udayveer-singh-180371201/", color: "hover:text-blue-600" },
                  { icon: Mail, href: "mailto:udayveerus348566@gmail.com", color: "hover:text-purple-600" }
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Passionate about developing robust, scalable web applications and creating seamless, user-friendly experiences across the full stack.
            </p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gradient-to-r from-white to-blue-50 p-6 rounded-2xl shadow-sm border border-blue-100 hover:shadow-lg transition-all duration-300">
                  <h4 className="font-semibold text-gray-900">B.Tech in Electronics & Instrumentation Engineering</h4>
                  <p className="text-gray-600 mt-1">A.P.J. Abdul Kalam Technical University (2018–2024)</p>
                  <p className="text-gray-600">Bundelkhand University Jhansi</p>
                </div>
              </div>
            </div>
      ...
      <section id="contact" className="py-20 px-6 relative">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {[
              { icon: Mail, href: "mailto:udayveerus348566@gmail.com", label: "Email", gradient: "from-red-500 to-pink-500" },
              { icon: Phone, href: "tel:+916392031395", label: "Phone", gradient: "from-green-500 to-emerald-500" },
              { icon: Linkedin, href: "https://www.linkedin.com/in/udayveer-singh-180371201/", label: "LinkedIn", gradient: "from-blue-500 to-cyan-500" },
              { icon: Github, href: "https://github.com/udayveerus", label: "GitHub", gradient: "from-gray-700 to-gray-900" }
          ...
          <a
            href="tel:+91-6392031395"
            className="bg-gradient-to-r from-pink-600 py-2 to-purple-600 text-white hover:from-pink-700 hover:to-purple-700 rounded-full px-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
          >
            Call Now
          </a>
        </div>
      ...
      <footer className="border-t border-gray-200 py-8 px-6 bg-gradient-to-r from-white to-gray-50">
        <div className="max-w-7xl mx-auto text-center text-gray-600">
          <p>&copy; 2024 Udayveer Singh. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
